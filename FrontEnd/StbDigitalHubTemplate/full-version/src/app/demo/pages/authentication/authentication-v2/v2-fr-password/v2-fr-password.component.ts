...
@Component({
  selector: 'app-v2-fr-password',
  imports: [RouterModule, ...SHARED_IMPORTS, FormField, LogoComponent, RouterLink],
  templateUrl: './v2-fr-password.component.html',
  styleUrl: './v2-fr-password.component.scss'
})
export class V2FrPasswordComponent implements OnInit {
