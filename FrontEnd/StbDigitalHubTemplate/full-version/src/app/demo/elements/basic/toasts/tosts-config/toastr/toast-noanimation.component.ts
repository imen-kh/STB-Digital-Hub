...
import { ApplicationRef, Component, ChangeDetectionStrategy, OnDestroy } from '@angular/core';
...
export function provideNoAnimationToastr(config: Partial<GlobalConfig> = {}): Provider[] {
  return [
    {
