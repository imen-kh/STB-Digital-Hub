...
import { InjectionToken, inject, Injectable, EventEmitter, Output, Input, ChangeDetectionStrategy, Component, ViewContainerRef, HostListener, Directive, Injector, ApplicationRef, TemplateRef, NgModule, makeEnvironmentProviders } from '@angular/core';
...
class SweetAlert2LoaderService {
    ...
    static ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "21.2.7", ngImport: i0, type: SweetAlert2LoaderService, deps: [], target: i0.ɵɵFactoryTarget.Injectable });
    static ɵprov = i0.ɵɵngDeclareInjectable({ minVersion: "12.0.0", version: "21.2.7", ngImport: i0, type: SweetAlert2LoaderService });
}
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "21.2.7", ngImport: i0, type: SweetAlert2LoaderService, decorators: [{
            type: Injectable
        }] });
...
class SwalDirective {
    ...
    static ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "21.2.7", ngImport: i0, type: SwalDirective, deps: [], target: i0.ɵɵFactoryTarget.Directive });
    static ɵdir = i0.ɵɵngDeclareDirective({ minVersion: "14.0.0", version: "21.2.7", type: SwalDirective, isStandalone: true, selector: "[swal]", inputs: { swal: "swal" }, outputs: { confirm: "confirm", deny: "deny", dismiss: "dismiss" }, host: { listeners: { "click": "onClick($event)" } }, ngImport: i0 });
}
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "21.2.7", ngImport: i0, type: SwalDirective, decorators: [{
            type: Directive,
            args: [{
                    selector: '[swal]',
                    standalone: true,
...
class SwalPortalTargets {
    ...
    static ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "21.2.7", ngImport: i0, type: SwalPortalTargets, deps: [], target: i0.ɵɵFactoryTarget.Injectable });
    static ɵprov = i0.ɵɵngDeclareInjectable({ minVersion: "12.0.0", version: "21.2.7", ngImport: i0, type: SwalPortalTargets, providedIn: 'root' });
}
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "21.2.7", ngImport: i0, type: SwalPortalTargets, decorators: [{
            type: Injectable,
...
class SwalPortalComponent {
    template = null;
    static ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "21.2.7", ngImport: i0, type: SwalPortalComponent, deps: [], target: i0.ɵɵFactoryTarget.Component });
    static ɵcmp = i0.ɵɵngDeclareComponent({ minVersion: "14.0.0", version: "21.2.7", type: SwalPortalComponent, isStandalone: true, selector: "swal-portal", inputs: { template: "template" }, ngImport: i0, template: '<ng-container *ngTemplateOutlet="template"></ng-container>', isInline: true, dependencies: [{ kind: "ngmodule", type: CommonModule }, { kind: "directive", type: i1.NgTemplateOutlet, selector: "[ngTemplateOutlet]", inputs: ["ngTemplateOutletContext", "ngTemplateOutlet", "ngTemplateOutletInjector"] }], changeDetection: i0.ChangeDetectionStrategy.OnPush });
}
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "21.2.7", ngImport: i0, type: SwalPortalComponent, decorators: [{
            type: Component,
            args: [{
...
class SwalPortalDirective {
    ...
    swalComponent = inject(SwalComponent, { host: true });
    /**
    ...
    createPortalComponent() {
        ...
        const componentRef = i0.createComponent(SwalPortalComponent, { environmentInjector: this.app.injector, elementInjector: this.injector });
        //=> Apply the consumer's template on the component
        componentRef.instance.template = this.templateRef;
        return componentRef;
    }
    static ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "21.2.7", ngImport: i0, type: SwalPortalDirective, deps: [], target: i0.ɵɵFactoryTarget.Directive });
    static ɵdir = i0.ɵɵngDeclareDirective({ minVersion: "14.0.0", version: "21.2.7", type: SwalPortalDirective, isStandalone: true, selector: "[swalPortal]", inputs: { target: ["swalPortal", "target"] }, ngImport: i0 });
}
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "21.2.7", ngImport: i0, type: SwalPortalDirective, decorators: [{
            type: Directive,
            args: [{
                    selector: '[swalPortal]',
                    standalone: true,
...
class SweetAlert2Module {
    static forRoot(options = {}) {
        return {
            ...
            providers: [
                ...
                SwalPortalTargets,
                { provide: swalProviderToken, useValue: options.provideSwal || provideDefaultSwal$1 },
        ...
        return {
            ...
            providers: [
                ...(options.provideSwal
                    ...
                    : []),
                ...(options.fireOnInit !== undefined ? [{ provide: fireOnInitToken, useValue: options.fireOnInit }] : []),
    ...
    static ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "21.2.7", ngImport: i0, type: SweetAlert2Module, deps: [], target: i0.ɵɵFactoryTarget.NgModule });
    static ɵmod = i0.ɵɵngDeclareNgModule({ minVersion: "14.0.0", version: "21.2.7", ngImport: i0, type: SweetAlert2Module, imports: [CommonModule, SwalComponent, SwalDirective, SwalPortalDirective, SwalPortalComponent], exports: [SwalComponent, SwalPortalDirective, SwalDirective, SwalPortalComponent] });
    static ɵinj = i0.ɵɵngDeclareInjector({ minVersion: "12.0.0", version: "21.2.7", ngImport: i0, type: SweetAlert2Module, imports: [CommonModule, SwalPortalComponent] });
}
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "21.2.7", ngImport: i0, type: SweetAlert2Module, decorators: [{
            type: NgModule,
            args: [{
